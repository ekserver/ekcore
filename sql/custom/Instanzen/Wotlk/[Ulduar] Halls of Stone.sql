-- macht die tribunalkiste nach dem event lootbar
UPDATE `gameobject_template` SET `flags` = 4 WHERE `entry` IN (190586,193996);

-- nonhero tribunalkiste nur auf nonhero spawnen
...
-- dunkle materie aus der db nicht spawnen
...
-- scriptnamen für dunkle materie / searing gaze
