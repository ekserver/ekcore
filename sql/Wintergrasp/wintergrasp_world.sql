...
REPLACE INTO `trinity_string` VALUES ('756', 'Battle begins!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Áèòâà íà÷àëàñü');
REPLACE INTO `trinity_string` VALUES ('757', '%s has successfully defended the fortress!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '%s óñïåøíî çàùèòèë(à) êðåïîñòü!');
REPLACE INTO `trinity_string` VALUES ('758', '%s has taken over the fortress!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '%s çàõâàòèë(à) êðåïîñòü');
...
REPLACE INTO `trinity_string` VALUES ('761', 'The %s tower has been damaged!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '%s áàøíÿ ïîâðåæäåíà');
REPLACE INTO `trinity_string` VALUES ('762', 'The %s tower has been destroyed!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '%s áàøíÿ óíè÷òîæåíà!');
...
REPLACE INTO `trinity_string` VALUES ('771', 'You have reached Rank 1: Corporal', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Âû äîñòèãëè Ðàíãà 1: Êàïðàë');
REPLACE INTO `trinity_string` VALUES ('772', 'You have reached Rank 2: First Lieutenant', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Âû äîñòèãëè Ðàíãà 2: Ëåéòåíàíò');
REPLACE INTO `trinity_string` VALUES ('780', 'Before the Battle of  Wintergrasp left 30 minutes!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Äî áèòâû íà  Îçåðå Ëåäÿíûõ Îêîâ îñòàëîñü 30 ìèíóò!');
REPLACE INTO `trinity_string` VALUES ('781', 'Before the Battle of  Wintergrasp left 10 minutes!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Äî áèòâû íà  Îçåðå Ëåäÿíûõ Îêîâ îñòàëîñü 10 ìèíóò!');
REPLACE INTO `trinity_string` VALUES ('782', 'The battle for Wintergrasp  has stopped! Not enough defenders. Wintergrasp Fortress remains  Attackers.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Áèòâà çà Îçåðî Ëåäÿíûõ Îêîâ Îñòàíîâëåíà. Íå õâàòàåò çàùèòíèêîâ. Êðåïîñòü ïåðåõîäèò àòàêóþùåé  ñòîðîíå.');
REPLACE INTO `trinity_string` VALUES ('783', 'The battle for Wintergrasp  has stopped! Not enough attackers. Wintergrasp Fortress remains  Defenders.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Áèòâà çà Îçåðî Ëåäÿíûõ Îêîâ Îñòàíîâëåíà. Íå õâàòàåò íàïàäàþùèõ. Êðåïîñòü îñòàåòñÿ çàùèòíèêàì.');
