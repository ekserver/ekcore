...
class npc_wyrm_sunwell_repairbot : public CreatureScript
{
public:
    npc_wyrm_sunwell_repairbot() : CreatureScript("npc_wyrm_sunwell_repairbot") { }
    ...
    bool OnGossipHello(Player* player, Creature* _Creature)
    {
        ...
        if(pInstance)
        {
            ...
            player->ADD_GOSSIP_ITEM(0, GOSSIP_START, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + TELE_START);
            player->ADD_GOSSIP_ITEM(0, GOSSIP_KALEG, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + TELE_KALEG);
            player->ADD_GOSSIP_ITEM(0, GOSSIP_BRUT, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + TELE_BRUT);
            player->ADD_GOSSIP_ITEM(0, GOSSIP_TWINS, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + TELE_TWINS);
            player->ADD_GOSSIP_ITEM(0, GOSSIP_MURU, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + TELE_MURU);
            //player->ADD_GOSSIP_ITEM(0, GOSSIP_KIL, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + TELE_KIL);
        }
    ...
    bool OnGossipSelect(Player* player, Creature* _Creature, uint32 sender, uint32 action)
    {
        ...
        switch(action)
        {
            ...
            break;
            case GOSSIP_ACTION_INFO_DEF + TELE_START: player->TeleportTo(580, TeleportPoints[0][0],TeleportPoints[0][1],TeleportPoints[0][2],0.0f); break;
            case GOSSIP_ACTION_INFO_DEF + TELE_KALEG: player->TeleportTo(580, TeleportPoints[1][0],TeleportPoints[1][1],TeleportPoints[1][2],0.0f); break;
            case GOSSIP_ACTION_INFO_DEF + TELE_BRUT:  player->TeleportTo(580, TeleportPoints[2][0],TeleportPoints[2][1],TeleportPoints[2][2],0.0f); break;
            case GOSSIP_ACTION_INFO_DEF + TELE_TWINS: player->TeleportTo(580, TeleportPoints[3][0],TeleportPoints[3][1],TeleportPoints[3][2],0.0f); break;
            case GOSSIP_ACTION_INFO_DEF + TELE_MURU:  player->TeleportTo(580, TeleportPoints[4][0],TeleportPoints[4][1],TeleportPoints[4][2],0.0f); break;
            case GOSSIP_ACTION_INFO_DEF + TELE_KIL:   player->TeleportTo(580, TeleportPoints[5][0],TeleportPoints[5][1],TeleportPoints[5][2],0.0f); break;
